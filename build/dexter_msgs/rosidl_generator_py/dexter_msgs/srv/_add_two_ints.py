...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dexter_msgs/AddTwoInts_Request, 1>',
        'response': 'sequence<dexter_msgs/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dexter_msgs', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dexter_msgs', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dexter_msgs.srv import AddTwoInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from dexter_msgs.srv import AddTwoInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dexter_msgs.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from dexter_msgs.srv._add_two_ints import AddTwoInts_Request as Request
    from dexter_msgs.srv._add_two_ints import AddTwoInts_Response as Response
    from dexter_msgs.srv._add_two_ints import AddTwoInts_Event as Event
