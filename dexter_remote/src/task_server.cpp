...
#include "dexter_msgs/action/dexter_task.hpp"
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<dexter_msgs::action::DexterTask>(
...
private:
  rclcpp_action::Server<dexter_msgs::action::DexterTask>::SharedPtr action_server_;
  ...
  rclcpp_action::GoalResponse goalCallback(
      ...
      std::shared_ptr<const dexter_msgs::action::DexterTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<dexter_msgs::action::DexterTask>> goal_handle)
  {
    (void)goal_handle;
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<dexter_msgs::action::DexterTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<dexter_msgs::action::DexterTask::Result>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(dexter_remote::TaskServer)